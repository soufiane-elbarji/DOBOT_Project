...
# --- Constants ---
POTRACE_PATH = "../potrace-1.16.win64/potrace.exe" # Assumes potrace is in system PATH
IMAGE_PATH = "../img_to_stroke_meth1/samples/image_4.png" # <--- SET THE PATH TO YOUR INPUT IMAGE
...
def generate_paths(edges):
    ...
    subprocess.run([POTRACE_PATH, img_path, "-s", "-o", "temp/svg_outline.svg"])
...
if __name__ == "__main__":
    ...
    if original_image is None:
        ...
        outline_image = generate_outline(original_image)
        
        print("Generating paths from outlines...")
        strokes, img_width, img_height = generate_paths(outline_image)
